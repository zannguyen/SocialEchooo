...
const getPost = async (req, res) => {
  try {
    const postId = req.params.id || req.query.postId || req.query.id;
...
const getCommunityPosts = async (req, res) => {
  try {
    const communityId =
      req.params.communityId || req.query.communityId || req.query.id;
...
const getFollowingUsersPosts = async (req, res) => {
  try {
    const communityId = req.params.id || req.query.communityId || req.query.id;
...
const deletePost = async (req, res) => {
  try {
    const id = req.params.id || req.query.postId || req.query.id;
